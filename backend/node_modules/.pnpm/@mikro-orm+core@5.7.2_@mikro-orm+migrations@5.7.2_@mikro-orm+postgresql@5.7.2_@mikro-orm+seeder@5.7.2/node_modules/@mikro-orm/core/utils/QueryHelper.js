    ...
    static processWhere(options) {
        ...
        return Object.keys(where).reduce((o, key) => {
            ...
            if (key in enums_1.GroupOperator) {
                o[key] = value.map((sub) => QueryHelper.processWhere({ ...options, where: sub, root: false }));
                return o;
            }
            ...
            if (prop?.customType instanceof JsonType_1.JsonType && Utils_1.Utils.isPlainObject(value) && !platform.isRaw(value) && Object.keys(value)[0] !== '$eq') {
